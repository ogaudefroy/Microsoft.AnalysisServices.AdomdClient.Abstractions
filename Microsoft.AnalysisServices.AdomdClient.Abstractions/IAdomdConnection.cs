namespace Microsoft.AnalysisServices.AdomdClient
{
    ...
    /// </summary>
    public interface IAdomdConnection : IDbConnection
    {
        /// <summary>
        /// Creates a new IAdomdCommand associated with this connection and returns its IAdoCommand object.
        /// </summary>
        /// <returns>The IAdoCommand object.</returns>
        new IAdomdCommand CreateCommand();
